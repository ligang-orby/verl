...
BID_TO_COORDINATE_ACTION_CONVERSION_TABLE = {value: key for key, value in COORDINATE_TO_BID_ACTION_CONVERSION_TABLE.items()}
...
def extract_values_maintain_types(string: str) -> list[str | float]:
    ...
    for kw in tree.keywords:
        args_list.append(ast.literal_eval(kw.value))  # Extract keyword arguments, ignoring names
